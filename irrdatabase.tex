...
% TODO
% Need to talk about the combination of fissile materials
...
% The calculated values for H$_{\gamma, Tr}$ and H$_{T}$ show good agreement with respect to the reference values.
...
%     H$_{ch}$            &  0.82   &  0.67   & 22.77   \\
%     H$_{\gamma, Tr}$    & 42.23   & 42.00   &  0.56   \\
%     H$_{T}$             & 43.06   & 42.67   &  0.91   \\
%     \multicolumn{4}{c}{86\% Fe, 10\% Cr, 4\% Al}      \\
%     H$_{ch}$            &  0.43   &  0.35   & 21.24   \\
%     H$_{\gamma, Tr}$    & 42.20   & 42.09   &  0.27   \\
%     H$_{T}$             & 42.63   & 42.45   &  0.44   \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%     H$_{ch}$            &  0.34   &  0.73   & -53.31  \\
%     H$_{\gamma, Tr}$    & 41.27   & 41.70   &  -1.04  \\
%     H$_{T}$             & 41.61   & 42.43   &  -1.94  \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
The generic irradiation database is based on the delayed heating calculation for the \gls*{MOC} values, which is a conservative approach \cite{ilas_impact_2013}.
...
%     \midrule
%     \multicolumn{4}{c}{Zircaloy-2}                        \\
%     H$_{ch}$            &    2.95   &    2.96   & -0.10   \\
%     H$_{\gamma, Tr}$    & 2357.88   & 2345.41   &  0.53   \\
%     H$_{T}$             & 2360.83   & 2348.37   &  0.53   \\
%     \multicolumn{4}{c}{Zircaloy-4}                        \\
%     H$_{ch}$            &    2.95   &    2.96   & -0.29   \\
%     H$_{\gamma, Tr}$    & 2357.86   & 2345.63   &  0.52   \\
%     H$_{T}$             & 2360.82   & 2348.59   &  0.52   \\
%     \multicolumn{4}{c}{ZrNb}                              \\
%     H$_{ch}$            &    2.99   &    3.31   & -9.75   \\
%     H$_{\gamma, Tr}$    & 2307.60   & 2314.60   & -0.30   \\
%     H$_{T}$             & 2310.59   & 2317.92   & -0.32   \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%     \midrule
%     \multicolumn{4}{c}{70\% Fe, 22\% Cr, 8\% Al}         \\
%     H$_{ch}$            &   14.87  &   12.21   & 21.80   \\
%     H$_{\gamma, Tr}$    & 2369.97  & 2358.40   &  0.49   \\
%     H$_{T}$             & 2384.84  & 2370.62   &  0.60   \\
%     \multicolumn{4}{c}{86\% Fe, 10\% Cr, 4\% Al}         \\
%     H$_{ch}$            &    7.57  &    6.24   & 21.39   \\
%     H$_{\gamma, Tr}$    & 2374.85  & 2367.56   &  0.31   \\
%     H$_{T}$             & 2382.42  & 2372.80   &  0.36   \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%     \midrule
%     \multicolumn{4}{c}{U(nat)-Mo}         \\
%     H$_{ch}$            &  3507.04   &  3416.95  &  2.64   \\
%     H$_{\gamma, Tr}$    &  7780.91   &  7358.50  &  5.74   \\
%     H$_{T}$             & 11287.95   & 10775.45  &  4.76   \\
%     \multicolumn{4}{c}{U(nat)-Nb}         \\
%     H$_{ch}$            &  3345.27   &  3306.49  &  1.17   \\
%     H$_{\gamma, Tr}$    &  7592.19   &  7156.94  &  6.08   \\
%     H$_{T}$             & 10937.46   & 10463.43  &  4.53   \\
%     \multicolumn{4}{c}{U(20\%)3Si2Al}     \\
%     H$_{ch}$            &  7783.68   &  7527.87  &  3.40   \\
%     H$_{\gamma, Tr}$    &  4690.24   &  4830.27  & -2.90   \\
%     H$_{T}$             & 12473.92   & 12358.14  & -0.94   \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
% %     H$_{ch}$            &  229.95   &  237.10  & -3.02  \\
% %     H$_{\gamma, Tr}$    & 2743.96   & 2754.34  & -0.38  \\
% %     H$_{T}$             & 2973.91   & 2991.44  & -0.59  \\
% %     \bottomrule
% %   \end{tabular}
% % \end{table}
...
%     \midrule
%     \multicolumn{4}{c}{SiC}        \\
%     H$_{ch}$            &    2.25  &    2.28  & -1.31  \\
%     H$_{\gamma, Tr}$    &  958.36  &  939.10  &  2.05  \\
%     H$_{T}$             &  960.60  &  941.38  &  2.04  \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%     \midrule
%     \multicolumn{4}{c}{SS}        \\
%     H$_{ch}$            &   54.70  &   57.28  &  -4.51  \\
%     H$_{\gamma, Tr}$    & 2401.44  & 2402.40  &  -0.04  \\
%     H$_{T}$             & 2456.14  & 2459.68  &  -0.14  \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%     H$_{ch}$            &  310.55  &  329.49  & -5.75   \\
%     H$_{\gamma, Tr}$    & 5463.04  & 5671.29  & -3.67   \\
%     H$_{T}$             & 5773.59  & 6000.78  & -3.79   \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%     \midrule
%     \multicolumn{4}{c}{RAFM}         \\
%     H$_{ch}$            &    9.01  &   12.66  & -28.83   \\
%     H$_{\gamma, Tr}$    & 2381.76  & 2369.79  &   0.51   \\
%     H$_{T}$             & 2390.77  & 2382.45  &   0.35   \\
%     \bottomrule
%   \end{tabular}
% \end{table}
