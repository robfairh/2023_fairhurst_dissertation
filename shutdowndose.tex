...
% Taking advantage of the MCNP input definition using repeated structures simplifies the definition of cells contributing to the delayed heating/shutdown dose rates.
